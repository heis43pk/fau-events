...
const Step4 = ({ formData, setFormData, handleImageUpload, styles, image }) => {
  ...
  return (
    <View>
      <Text>Create New Event - Step 4  </Text>
      ...
      <Kohana
        ...
        inputPadding={16}
        onChangeText={(text) => setFormData({ ...formData, location: text })}
        style={styles.input} // Use custom style for input field
        inputStyle={styles.inputField} // Use custom input style
      />
...
<View style={styles.inlineContainer}>
    ...
    {image?.uri && ( // Check if formData.image and formData.image.uri exist
        <View>
          <Text>Preview:</Text>
